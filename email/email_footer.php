                ...
                <tr style="background:#179b29">
                    <td style="padding: 10px;width: 33%; text-align: center; color:white;">
                       <!--  <webversion style="color:#666666; text-decoration:underline; font-weight: bold;">View as a Web Page</webversion> -->
                        <a style="color:white; text-decoration: none;" href="http://courscomplementaires.ch/">Cours Complémentaires 2019-2020</a> | Powered by <a style="color:white; text-decoration: none;" href="https://webfactor.ch"><strong>Web</strong>Factor</a>
                    </td>
                </tr>
            </table>
            <!-- Email Footer : END -->
