...
$post_ids =  array_map( function($p){ return $p->ID; } , $posts_array);
...
$location_ids =  array_map(function($p) {  return $p->wid; } , $course_locations);
...
foreach ($posts_array as $post) {
    ...
    $locations =  array_values(array_map(function($p){ return $p->wid; }, $location));
    ...
    if ($post->location) {
        ...
        $zones =  array_values( array_map( function($l) {return $l->wid;}, $zone));
        $post->zone = $zones;
