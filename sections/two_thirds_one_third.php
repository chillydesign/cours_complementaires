...
<?php  $classes = ($image_position == 'right') ?  [ 'col-sm-8', 'col-sm-4' ]  :  [ 'col-sm-8 col-sm-push-4', 'col-sm-4 col-sm-pull-8' ]  ; ?> 
<div class="container">
	<div class="row">
		...
		<div class="one_third_image" style="background-image:url(<?php echo $image['url']; ?>);"  ></div>
		</div>
